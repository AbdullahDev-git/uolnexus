    ...
    return (
      <div className="flex items-center justify-center h-full min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-400">Loading libraries...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="flex items-center justify-center h-full min-h-[400px] px-6">
        <div className="text-center max-w-sm">
          ...
          <p className="text-sm text-gray-500">Unable to load libraries. Please check your connection.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="relative h-full min-h-0">
      <div className="absolute top-4 left-1/2 -translate-x-1/2 z-10 pointer-events-none">
        <div className="bg-white/90 backdrop-blur-md rounded-2xl px-5 py-2.5 shadow-lg pointer-events-auto">
          <h2 className="font-bold text-navy text-sm sm:text-lg text-center">Libraries</h2>
        </div>
      </div>
          ...
          >
            <Popup>
              <div className="text-center min-w-[140px]">
                <p className="font-semibold text-navy text-sm">{lib.name}</p>
              </div>
            </Popup>
          </Marker>
        ))}
